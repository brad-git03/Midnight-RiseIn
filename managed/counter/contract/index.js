...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.secretIncrement) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named secretIncrement');
    }
    ...
    this.circuits = {
      increment: (...args_1) => {
        ...
        const result_0 = this._increment_0(context, partialProofData, val_0);
  ...
  _secretIncrement_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.secretIncrement(witnessContext_0);
  ...
  _increment_0(context, partialProofData, val_0) {
    const witnessVal_0 = this._secretIncrement_0(context, partialProofData);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
...
const _dummyContract = new Contract({
  secretIncrement: (...args) => undefined
});
